...
export const TRANSLATIONS: Record<Language, LocaleStrings> = {
  en: {
    appTitle: "BUSINESS LAB",
    appSubtitle: "Initialize the scanning protocol. We will locate machine-based Fad ventures and opportunities for you.",
    ...
    saveCanvasLocal: "Save Blueprint (Local)",
    downloadPdf: "Download PDF",
    downloading: "Generating PDF...",
    canvasSavedMsg: "Blueprint saved to local storage successfully.",
    scanComplete: (c) => `Scan Complete: ${c} Ventures Found`,
    ...
    login: {
      ...
      subtitle: "Authenticate to access the Fad Business Lab",
    ...
    dashboard: {
      ...
      noSaved: "No concepts archived yet. Return to the Lab Scanner.",
    ...
    community: {
      title: "Fad connect",
      subtitle: "Collaborate with other operatives in the Lab Hive. Share intel and form alliances.",
      feed: "Global Feed",
    ...
    chat: {
        ...
        greeting: "Greetings, Operative! Prof. Fad here. Ready for a business breakthrough in the Lab?",
    ...
    about: {
      intro: "Fad Business Lab is a futuristic intelligence platform designed to identify tangible, machine-based Fad ventures for the modern entrepreneur.",
      missionTitle: "The Mission",
      missionText: "Our core directive is to democratize access to manufacturing and service-based business models. By analyzing global supply chains and correlating them with local market needs, we generate actionable business blueprints in the Fad Lab environment.",
      step1Title: "Scan & Identify",
      step1Text: "Select a sector or build your profile. Our AI scans global marketplaces to find affordable machines that power high-margin ventures.",
      step2Title: "Analyze Model",
      step2Text: "Deep dive into requirements. We generate a full Business Model Blueprint, SWOT analysis, and marketing tips instantly.",
      ...
      featuresTitle: "Lab Features",
      features: [
        "AI-Powered Market Scanning",
        "Real-time Machine Sourcing Data",
        "Instant Business Model Blueprint Generation",
        "Personalized Opportunity Matching",
        "Operational Requirement Analysis",
        "Cyberpunk Lab UI for Enhanced Focus"
      ],
...
${user}`
    ...
    errors: {
      ...
      canvasFail: "Failed to generate blueprint.",
      detailsFail: "Failed to load details.",
      loginFail: "Authentication Failed. Use Guest Mode.",
  ...
  am: {
    appTitle: "ቢዝነስ ላብ",
    appSubtitle: "የፍተሻ ፕሮቶኮሉን ለመጀመር የኢንዱስትሪ ዘርፍ ይምረጡ። ለእርስዎ የሚሆኑ ፋድ ቬንቸርስ እንፈልግልዎታለን።",
    ...
    canvasSavedMsg: "የቢዝነስ ብሉፕሪንቱ በተሳካ ሁኔታ ተቀምጧል።",
    ...
    login: {
      title: "መግቢያ ተርሚናል",
      subtitle: "ፋድ ቢዝነስ ላብን ለመጠቀም ማንነትዎን ያረጋግጡ",
      emailLabel: "ኢሜይል",
      passLabel: "የይለፍ ቃል",
      loginBtn: "ወደ ውስጥ ግባ",
    ...
    dashboard: {
      ...
      noSaved: "እስካሁን ምንም ሀሳቦች አልተቀመጡም። ወደ ላብ ስካነሩ ይመለሱ።",
    ...
    community: {
      title: "ፋድ ኮኔክት",
      subtitle: "ከሌሎች ኦፕሬተሮች ጋር በላብ ሃይቭ ይተባበሩ።",
      feed: "ዓለም አቀፍ ግድግዳ",
      channels: "ንቁ ድግግሞሾች",
    ...
    chat: {
        ...
        greeting: "ሰላም ኦፕሬቲቭ! ፕሮፌሰር ፋድ ነኝ። በፋድ ላብ አዲስ የንግድ ግኝት ይፈልጋሉ?",
    ...
    about: {
      intro: "ፋድ ቢዝነስ ላብ ለዘመናዊ ኢንተርፕረነሮች ተጨባጭ እና ማሽን ላይ የተመሰረቱ ፋድ ቬንቸርስን ለመለየት የተነደፈ የወደፊት ኢንተለጀንስ መድረክ ነው።",
      missionTitle: "ተልዕኮ",
      missionText: "ዋናው አላማችን የማምረቻ እና የአገልግሎት ተኮር የንግድ ሞዴሎችን ተደራሽ ማድረግ ነው። በፋድ ላብ አካባቢ ተግባራዊ የሆኑ የንግድ ብሉፕሪንቶችን እናመነጫለን።",
      ...
      step2Text: "የክወና መስፈርቶችን በጥልቀት ይመርምሩ። ሙሉ የቢዝነስ ብሉፕሪንት፣ SWOT ትንታኔ እና የግብይት ምክሮችን ወዲያውኑ እናመነጫለን።",
      step3Title: "ይተግብሩ እና ያስቀምጡ",
      step3Text: "የሚወዷቸውን ፅንሰ-ሀሳቦች በዳሽቦርድዎ ላይ ያስቀምጡ። የክወና መስፈርቶችን ይገምግሙ እና ለስራ ዝግጁ ይሁኑ።",
      featuresTitle: "የላብ ባህሪያት",
      features: [
        "በ AI የሚታገዝ የገበያ ቅኝት",
        "የእውነተኛ ጊዜ ማሽን መረጃ",
        "ፈጣን የቢዝነስ ብሉፕሪንት ማመንጨት",
        "ለእርስዎ የተበጁ እድሎች",
        "የክወና መስፈርቶች ትንታኔ",
        "ዘመናዊ ሳይበርፓንክ ላብ ዩዘር ኢንተርፌስ"
      ],
...
${user}`
    ...
    errors: {
      ...
      canvasFail: "የቢዝነስ ብሉፕሪንት ማመንጨት አልተሳካም።",
      detailsFail: "ዝርዝር መረጃን መጫን አልተሳካም።",
      loginFail: "የተሳሳተ መረጃ። እባክዎ እንደ እንግዳ ይግቡ።",
